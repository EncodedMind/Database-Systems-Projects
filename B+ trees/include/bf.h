...
#define BF_BUFFER_SIZE                                                                        \
    100 /* Ο μέγιστος αριθμός block που κρατάμε στην μνήμη \
         */
...
typedef enum BF_ErrorCode {
    ...
    BF_ACTIVE_ERROR, /* Το επίπεδο BF είναι ενεργό και δεν μπορεί να
                      * αρχικοποιηθεί
                      */
    BF_FILE_ALREADY_EXISTS, /* Το αρχείο δεν μπορεί να δημιουργιθεί γιατι
                               υπάρχει ήδη */
    BF_FULL_MEMORY_ERROR, /* Η μνήμη έχει γεμίσει με ενεργά block */
    BF_INVALID_BLOCK_NUMBER_ERROR, /* Το block που ζητήθηκε δεν υπάρχει στο
                                    * αρχείο
                                    */
